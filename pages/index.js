    ...
    <div id="hero">
      ...
      <ul id="homepage-projects">
        <li>Co-founder and CTO of
          <a href="https://codeinterview.io" target="_blank" className="project-link"><img src="/img/icons/ci.png" />CodeInterview.io</a> &
          <a href="https://remoteinterview.io" target="_blank" className="project-link"><img src="/img/icons/ri.png" />RemoteInterview.io</a>.
        ...
        <li>Creator of
          <ul>
            <li><a href="/projects/screenshothero/" className="project-link"><img src="/img/icons/screenshothero.png" />Screenshot Hero</a> – iOS app that scans through screenshots and makes them searchable by text in them.
            ...
            <li><a href="https://zeroserver.io" target="_blank" className="project-link"><img src="/img/icons/zero.png" />Zero</a> – Web framework that abstracts complex project configuration for routing, bundling, etc. to make it web-dev easy.
            ...
            <li><a href="https://apps.apple.com/us/app/coco-music/id1401506547/" target="_blank" className="project-link"><img src="/img/icons/coco.png" />Coco Music</a> – A fast music streaming client for iOS and Android, specially optimized and co-located for South Asian users.</li>
            <li><a href="https://apps.apple.com/us/app/double-recorder/id1480805574" target="_blank" className="project-link"><img src="/img/icons/doublerecorder.png" />Double Recorder</a> – iOS video recorder to record from both cameras (front and back) simultaneously.</li>
            <li><a href="https://www.allmydesktops.com/" target="_blank" className="project-link"><img src="/img/icons/allmydesktops.png" />AllMyDesktops.com</a> – Fastest browser-based client for RDP and VNC. Zero installations.
            ...
            <li><a href="https://github.com/asadm/urduscript/" target="_blank" className="project-link"><img src="/img/icons/urduscript.png" />UrduScript</a> – JavaScript dialect in Urdish, with a goal to make programming more accessible for beginners from South Asia.</li>
            <li><a href="https://recordscreen.io/" target="_blank" className="project-link"><img src="/img/icons/recordscreen.png" />RecordScreen.io</a> – Screen recorder right in the browser. No installation required.
            ...
            <li><a href="https://www.startuplist.pk/" target="_blank" className="project-link"><img src="/img/icons/startuplist.png" />Startuplist.pk</a> – Pakistani startup database.</li>
