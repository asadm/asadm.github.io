      ...
      <li>Making <a href="https://joinplayroom.com/" target="_blank" className="project-link"><img src="/assets/img/icons/playroom.png" />Playroom</a>.</li>
        ...
        <li>Creator of
          ...
          <li><a href="https://www.codecaptcha.io" target="_blank" className="project-link"><img src="/assets/img/icons/codecaptcha.png" />CodeCaptcha.io</a> – Hide your web link behind a coding challenge.
            ...
            <li><a href="https://github.com/remoteinterview/zero/" target="_blank" className="project-link"><img src="/assets/img/icons/zero.png" />Zero</a> – Web framework that abstracts complex project configuration for routing, bundling, etc. to make it web-dev easy.
